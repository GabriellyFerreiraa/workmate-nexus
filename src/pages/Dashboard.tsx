...
const Dashboard = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <header className="border-b bg-card">
        <div className="flex h-16 items-center justify-between px-6 bg-gray-300">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 border shadow-lg bg-popover">
      ...
      {/* Main Content */}
      <main className="p-6">
        {userProfile.role === 'lead' ? <LeadDashboard /> : <AnalystDashboard />}
      </main>
    </div>;
};
